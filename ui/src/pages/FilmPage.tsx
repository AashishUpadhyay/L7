  ...
  return (
    <div className="max-w-6xl">
      <nav className="flex items-center gap-2 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-800 font-medium">Manage Movies</span>
      </nav>
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="text-gray-700">
              {selectedGenres.length === 0 ? 'Filter by Genre' : `${selectedGenres.length} Genre${selectedGenres.length > 1 ? 's' : ''}`}
            </span>
            <svg className={`w-4 h-4 text-gray-400 transition-transform ${genreDropdownOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-20 max-h-80 overflow-y-auto">
                <div className="p-2">
                  <div className="flex items-center justify-between px-2 py-2 border-b border-gray-200 mb-2">
                    <span className="text-sm font-medium text-gray-700">Select Genres</span>
                ...
                return (
                  <React.Fragment key={movie.id}>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <Link to={`/admin/movies/${movie.id}`} className="p-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors inline-flex items-center justify-center" title="View" aria-label="View">
                              ...
                              <div className="space-y-1">
                                {persons.map((person) => (
                                  ...
                                  >
                                    ...
                                    <Link
                                      to={`/admin/professionals/${person.person_id}`}
